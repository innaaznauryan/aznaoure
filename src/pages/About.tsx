      ...
      <section className="py-12 sm:py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-8 sm:mb-12 lg:mb-16"
          >
            <p className="luxury-subheading mb-3 sm:mb-4">Our Heritage</p>
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
              Moments in History
            </h2>
          ...
          <div className="max-w-2xl mx-auto space-y-8 sm:space-y-10 lg:space-y-12 px-4">
            {[
              {
                year: "1892",
                title: "The Beginning",
                description:
                  "Henri Duval opens the first Aurum atelier on Place Vendôme, Paris.",
              },
              {
                year: "1925",
                title: "Art Deco Era",
                description:
                  "Aurum becomes known for pioneering Art Deco jewelry designs.",
              },
              {
                year: "1962",
                title: "Global Expansion",
                description:
                  "Opening of boutiques in New York, London, and Tokyo.",
              },
              {
                year: "2010",
                title: "Sustainable Future",
                description:
                  "Launch of our ethical sourcing initiative and commitment to sustainability.",
              },
            ].map((milestone, index) => (
              <motion.div
                key={milestone.year}
              ...
              >
                <span className="font-serif text-2xl sm:text-3xl text-primary sm:min-w-[80px]">
                  {milestone.year}
                </span>
                <div>
                  <h3 className="font-serif text-lg sm:text-xl mb-2">{milestone.title}</h3>
